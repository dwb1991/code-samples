...
if __name__ == "__main__":
	...
	Generate_Step_2_Heatmap(step_1_csv, how_many_users=10, freq = 'M', min_number_of_emails = 1000) 
	...
	Generate_Step_3_Graph(df, how_many_users = 10, min_number_of_emails = 1000)
